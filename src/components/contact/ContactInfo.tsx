  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "thomasmorris@gmail.com",
      link: "mailto:thomasmorris@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Austin, TX, USA",
      link: "https://maps.google.com/?q=Austin",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/thomas-morris-089b2b355/",
    },
  ];
