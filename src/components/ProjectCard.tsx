...
import { LucideIcon, Github, AppWindowMac, AppWindow } from "lucide-react";
...
const ProjectCard = ({ title, description, image, tags, play, app, category, icon: Icon }: ProjectCardProps) => {
        ...
        <div className="flex justify-center">
          {
            play && <motion.a
              ...
              className="inline-flex items-center text-muted-foreground hover:text-brand-purple transition-colors mr-12"
          ...
          }
          {
            app && <motion.a
              ...
              whileTap={{ scale: 0.95 }}
            >
              <AppWindowMac className="mr-1.5 h-4 w-4" />
              App Store
            </motion.a>
          }
        </div>
