...
const SkillsSection = () => {
  ...
  const skills = [
    ...
    { name: "TypeScript", category: "Frontend", color: "#11557C", bgColor: "bg-blue-700/20" },
    { name: "React Native", category: "Mobile", color: "#FF6F00", bgColor: "bg-orange-600/20" },
    { name: "iOS", category: "Mobile", color: "#181717", bgColor: "bg-gray-900/20" },
    { name: "XCode", category: "Tool", color: "#F24E1E", bgColor: "bg-indigo-900/20" },
    { name: "Android", category: "Mobile", color: "#3776AB", bgColor: "bg-blue-500/20" },
    { name: "Android Studio", category: "Tool", color: "#FF6F00", bgColor: "bg-orange-600/20" },
    ...
    { name: "VSCode", category: "Tool", color: "#5C3EE8", bgColor: "bg-purple-600/20" },
    { name: "Firebase", category: "Database", color: "#F24E1E", bgColor: "bg-red-500/20" },
    
  ];

  const categories = ["All","Frontend", "Mobile", "Backend", "Databases", "Tools"];

  const filteredSkills = activeFilter === "All" 
    ? skills 
    : skills.filter(skill => {
        if (activeFilter === "Frontend") return skill.category === "Frontend" || skill.category === "Language";
        if (activeFilter === "Mobile") return skill.category === "Mobile";
